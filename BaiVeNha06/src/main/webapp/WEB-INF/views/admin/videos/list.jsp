...
<div class="card">
    <div class="card-header">
        <span><i class="fas fa-video"></i> List Video</span>
        <span>
            <a href="<c:url value='/admin/videos/add'/>" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> Add New</a>
            <a href="<c:url value='/admin/videos/search'/>" class="btn btn-info btn-sm"><i class="fas fa-search"></i> Search</a>
        </span>
    </div>
    <div class="card-body">
